...
const en = {
  ...
  articles: {
    ...
    allTopics:     'All',
    countAll:      '{n} articles',
    countSome:     '{v} of {n} articles',
    ctaTitle:      'Have a project in mind?',
    ctaText:       'Thirty years of visualization, one studio, and direct contact with the person doing the work.',
  ...
  about: {
    ...
    labsLabel:        'Side projects',
    labsTitle:        'Vision Graphics Labs',
    labsLead:         'Free browser toys, tools and games — light, colour, geometry and sound, small enough to give away.',
    labsBody:         'The same skills that visualize a building also make a sun-path simulator, a lens and depth-of-field wheel, a floor-plan-to-3D tool, a spatial-aptitude daily game. We publish them at labs.visiongraphics.eu: everything runs in your browser, nothing is uploaded, no accounts, no ads, no tracking. If one of them makes you want the full-scale version of that competence, that is what the studio does.',
    labsBtn:          'Open the labs',
...
const hu: Strings = {
  ...
  articles: {
    ...
    countAll:      '{n} cikk',
    countSome:     '{v} / {n} cikk',
    ctaTitle:      'Van egy projektje?',
    ctaText:       'Harminc év látványtervezés, egy stúdió, és közvetlen kapcsolat azzal, aki a munkát végzi.',
  ...
  about: {
    ...
    labsLabel:        'Mellékprojektek',
    labsTitle:        'Vision Graphics Labs',
    labsLead:         'Ingyenes böngészős játékok, eszközök és kísérletek — fény, szín, geometria és hang, épp elég kicsik ahhoz, hogy elajándékozzuk.',
    labsBody:         'Ugyanaz a tudás, amely egy épületet vizualizál, napjárás-szimulátort, objektív- és mélységélesség-kereket, alaprajzból 3D-t készítő eszközt és napi térlátás-játékot is szül. A labs.visiongraphics.eu címen tesszük közzé őket: minden a böngészőben fut, semmi nem töltődik fel, nincs fiók, nincs reklám, nincs követés. Ha valamelyik kedvet csinál ugyanennek a tudásnak a teljes léptékű változatához, azt csinálja a stúdió.',
    labsBtn:          'Irány a labor',
